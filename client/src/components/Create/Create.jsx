...
import { createDogs, getTemperaments } from "../../redux/actions/actions";
import './createdDogs.css'

const validateText = (input) => {
    const err = {};
  
    if (!input.name) err.name = "Write the name";
    else if (input.name.length > 50) err.name = "Maximum number of characters: 50"
    ...
    return (
      <div className="form-container">
        <div className="form-body">
          ...
          <h2 className="form-title">Complete the form and create your dog!</h2>
